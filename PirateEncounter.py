...
class PirateEncounter(object):
    ...
    def pirate_attack(self):
        ...
        while FightingPirates:
            print("----------------------------------------------------------")
            print("There are %d pirates remaining." % self.number_of_pirates)
            print("You've %s cannons and your ship health is %s" % (self.game.cannons, self.game.ship_health))
            print("")
    ...
    def fight(self):
        ...
        return True if self.number_of_pirates <= 0 else False
